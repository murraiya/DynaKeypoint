...
# )
# CHECKPOINT_PATH = os.path.join(
#     os.path.dirname(__file__), "../../../lightning_logs/silkimpl_250103/checkpoints/epoch=6589-step=6589.ckpt"
# )
# CHECKPOINT_PATH = os.path.join(
#     os.path.dirname(__file__), "../../../lightning_logs/silkimpl_250106/checkpoints/epoch=13-step=11703.ckpt"
# )
CHECKPOINT_PATH = os.path.join(
    os.path.dirname(__file__), "../../../lightning_logs/silkimpl_250114_recent/checkpoints/epoch=0-step=835.ckpt"
)
...
SILK_THRESHOLD = 0.8  # keypoint score thresholding, if # of keypoints is less than provided top-k, then will add keypoints to reach top-k value, 1.0 = disabled
SILK_TOP_K = 3000
...
def get_model(
    ...
    model = SJNet(default_outputs=default_outputs,
