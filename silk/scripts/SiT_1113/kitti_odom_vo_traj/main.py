...
def main(seq):
    ...
    for sample in tqdm(framework): #2790 files to test
        ...
        abs_gt = sample['abs_pose'][0] # [0], [1] np.ndarray 4x4 transformation mat
        ...
        # cv2.circle(traj, (int(gt_x)+290, int(gt_y)+200), 1, (0, 0, 255), 1) # red BGR order
        cv2.circle(traj, (int(gt_y)+290, int(gt_z)+200), 1, (0, 0, 255), 1) # red BGR order
