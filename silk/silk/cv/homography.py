...
class HomographicSampler:
    ...
    def sj_transform_points(
        ...
        # print(max(points[0,0,:]))
        # print(max(points[0,1,:]))
        # print(max(points[0,2,:]))
        # tensor(487.5000, device='cuda:1')
        # tensor(296.5000, device='cuda:1')
        ...
        # tensor(617.7658, device='cuda:1', dtype=torch.float64)
        # tensor(178.6385, device='cuda:1', dtype=torch.float64)
    ...
    def transform_points(
        ...
        # points: x,y order
        # crop point: row,column order
        transformed_points[0,:,0] -= crop_point[1]
        transformed_points[0,:,1] -= crop_point[0]
