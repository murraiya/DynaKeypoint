...
class SiLKBase(AutoForward, torch.nn.Module):
    ...
    # ("descriptors", "logits", "sparse_positions", "sparse_descriptors", "nms", "depthpro"),
    #         self._model.forward_flow,
    #         outputs=Flow.Constant(("normalized_descriptors", "logits", "sparse_positions", "sparse_descriptors", "nms", "depthpro")),
    #         images = "gray_images",
    #         whole_images = whole_images,
    #         intrinsics = intrinsics,
